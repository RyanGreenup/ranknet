...
*** Visualising Model Performance
    ...
    shown[fn:15] in figure [[ranked_blobs_unordered]].
...
** Evaluate performance improvements
  ...
  previous work cite:viksinghComparisonOpenSource2009.
   ...
   2. How to measure the performance of ranked documents
     - There is some guidance on this by past work, see e.g. cite:viksinghComparisonOpenSource2009.
