...
** Implement Ranknet                                                            :f25f376:05df04f:
   ...
   #+end_src
    ...
    #+BEGIN_SRC R :exports results :results output graphics file :file ranknet_loss.png :eval never
      library(tidyverse)
      ...
      ggplot(data, aes(x = iteration, y = losses)) +
    ...
    #+attr_html: :width 400px
    #+attr_latex: :width 0.4\textwidth
    #+RESULTS[4dc8a85a43a77b706337ded0072cc441bbdbf9a1]:
    [[file:ranknet_loss.png]]
