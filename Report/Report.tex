...
see \S \ref{sec:orgae10e44} of the appendix.

\section{Implementation}
\label{sec:org0f0edf8}
\subsection{Neural Networks}
\label{sec:org2a301e7}
...
changes made in that section. See \S \ref{sec:org2cd158e} for
more specific guidance.



\paragraph{Code listings}
\label{sec:org4fedf15}
The code listings provided will use a standard set of import
statements (see \S \ref{sec:org8b5c985} ) and so they will be
...
learn as shown below and visualized\footnote{See \S \ref{sec:orge1b828e} for the specific method definition used to
export the data to a \texttt{csv.}} in figure \ref{fig:org0a49215}.\footnote{Visualisations for this Report were implemented using
...
available at \href{https://github.com/RyanGreenup/ranknet/blob/main/Report/Report.org}{github.com/RyanGreenup/ranknet/blob/main/Report/Report.org}\label{org8568249}}
...
\caption{\label{fig:org0a49215}Generated data, output classes denote document relevance and the axis features or principle components}
\end{figure}

\subsection{Creating a Neural Network\hfill{}\textsc{7291112}}
\label{sec:org5041c48}
...
over time is shown in figure \ref{fig:orgd73e878}.
...
\caption{\label{fig:orgd73e878}Training error, given by \(l\left( x \right) = \sum^{n}_{i= 1} \left[ \left( x_i - f\left( x_i \right)  \right)^2  \right]\), at each iteration of training}
\end{figure}

\subsection{Implement Ranknet\hfill{}\textsc{f25f376:05df04f}}
\label{sec:orge26ad9b}
...
after (\texttt{05df04f}). see \S \ref{sec:org0082873}}
...
provided at figure \ref{fig:orgfa4e4c2}. 
...
\caption{\label{fig:orgfa4e4c2}BCE training loss at each iteration for the Ranknet method.}
\end{figure}

\subsection{Implement sorting\hfill{}\textsc{99b390a:7d46636}}
\label{sec:org3183039}
...
The data can then be plotted, as in figure \ref{fig:org10de7ed} and exported like so:\footnote{In this case the plot has been generated by \emph{GGPlot2} \textsuperscript{\ref{org8568249}}}
...
\caption{\label{fig:org10de7ed}Using Machine Learned Ranking to order the points from most to least relevant}
\end{figure}

\subsubsection{Visualising Model Performance}
\label{sec:org4ffd750}
Although the results in figure \ref{fig:org10de7ed} appear very
...
shown\footnote{For Clarity sake the colours have been inverted.} in figure \ref{fig:orgbc8f784}.
...
\caption{\label{fig:orgbc8f784}Using Machine Learned Ranking to order the points from most to least relevant}
\end{figure}


\subsection{Enhancing the Model}
\label{sec:org1aea73b}
...
discussed in \S \ref{sec:org4ffd750}.

\section{Further Research}
\label{sec:orgcfa30a2}
...
\section{Appendix}
\label{sec:orgf687bcb}

\subsection{Search Engines}
\label{sec:orgae10e44}
